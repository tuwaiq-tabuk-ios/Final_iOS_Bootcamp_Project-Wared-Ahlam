...
class HospitalsTableViewCell: UITableViewCell {
    ...
    func configureCell(hospital: HospitalModel, isSelected: Bool) {
        containerView.layer.borderColor = isSelected ?  #colorLiteral(red: 0.2509803922, green: 0.6549019608, blue: 0.5960784314, alpha: 1) : #colorLiteral(red: 0.6666666865, green: 0.6666666865, blue: 0.6666666865, alpha: 1)
